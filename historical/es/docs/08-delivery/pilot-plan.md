> **Histórico — documento en español.** Archivado el 18 de agosto de 2026. La especificación vigente está en [English canonical document](../../../../docs/08-delivery/pilot-plan.md); no agregar requisitos, decisiones ni cambios nuevos a este registro.
...
Validar que el sistema sea útil, seguro y sostenible en una tarde real, no solo que el software funcione.

## Piloto de fundadora — ocho semanas

- Usar el sistema semanalmente durante ocho semanas con la hija de cinco años de la fundadora.
- Ejecutar primero 3 actividades para calibrar el esquema y después ampliar hasta la biblioteca piloto.
- Registrar preparación, duración, fallas y roles reales.
- Ajustar Activity Schema y escala de independencia.
...
- Un niño en la familia fundadora y sesiones de dos o tres niños en las familias amigas.
- Adultos con distinta comodidad técnica.
- Distintos niveles de inventario y espacio.
- Rango de edad dentro del alcance aprobado.
...
No solicitar fotos de niños ni grabación continua. Medios de troubleshooting siguen política temporal.

## Entrevistas

- Onboarding: expectativas y restricciones.
- Semanal: cinco minutos como máximo; qué funcionó y qué sobró.
- Cierre: entrevista final sobre valor, confianza y carga.

## Criterios provisionales de éxito

- 70% o más de actividades iniciadas llegan a un cierre útil.
- Mediana de cierre inferior a 20 segundos para tres niños.
...
Los umbrales deben aprobarse antes del piloto y no reemplazan análisis cualitativo.
