> **Histórico — documento en español.** Archivado el 18 de agosto de 2026. La especificación vigente está en [English canonical document](../../../../docs/08-delivery/traceability.md); no agregar requisitos, decisiones ni cambios nuevos a este registro.
...
- El artefacto editable vive en [`prototypes/family-mobile-v0.1/`](../../prototypes/family-mobile-v0.1/README.es.md).
