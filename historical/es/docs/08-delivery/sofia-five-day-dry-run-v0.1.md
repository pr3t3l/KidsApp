> **Histórico — documento en español.** Archivado el 18 de agosto de 2026. La especificación vigente está en [English canonical document](../../../../docs/08-delivery/sofia-five-day-dry-run-v0.1.md); no agregar requisitos, decisiones ni cambios nuevos a este registro.

# Dry run de cinco días con Sofía v0.1

> **Versión inglesa vigente:** [Five-Day Dry Run with Sofia](../../../../docs/08-delivery/sofia-five-day-dry-run-v0.1.md).
