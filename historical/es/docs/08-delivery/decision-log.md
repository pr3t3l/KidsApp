> **Histórico — documento en español.** Archivado el 18 de agosto de 2026. La especificación vigente está en [English canonical document](../../../../docs/08-delivery/decision-log.md); no agregar requisitos, decisiones ni cambios nuevos a este registro.
...
| DEC-013 | Usar español como idioma fuente de specs v0.x. | Reemplazada por DEC-052 | Idioma de trabajo anterior. |
...
| DEC-051 | Entregar el founder pilot con bundles completos `es-US` y `en-US` sobre el mismo modelo y recorrido; persistir la elección de idioma, usar manifiestos instalables localizados y bloquear mediante QA cualquier pantalla inglesa con texto español residual. | Aprobada | Cumple el mercado bilingüe sin duplicar lógica, evita pantallas mixtas y respetaba la política de fuente española vigente en ese momento. |
| DEC-052 | Usar inglés como idioma fuente normativo para toda documentación nueva y cambios futuros; conservar las especificaciones en español como registros históricos. | Aprobada | La fundadora confirmó que la colaboración y el trabajo futuro se harán en inglés, manteniendo el contenido español para trazabilidad e historia sin crear dos fuentes activas. |
