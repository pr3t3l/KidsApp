> **Histórico — documento en español.** Archivado el 18 de agosto de 2026. La especificación vigente está en [English canonical document](../../../../../docs/02-content/sample-activities/ACT-0002-clasificacion-semillas.md); no agregar requisitos, decisiones ni cambios nuevos a este registro.
...
1. Confirm that no participant has a known or suspected legume/seed allergy and that no participant tends to place small objects in the mouth, nose, or ears. If either condition applies, choose another activity. Also confirm that only the four exact varieties in this version are present.
2. Keep children under age 5 and pets away from the activity area.
3. Count and inspect 12 items from each of the four types. Discard any damaged, damp, moldy, or excessively dusty pieces.
4. Mix all 48 items in the tray without revealing the quantity of each type.
5. Place five containers along the top of the tray and the large paper in the middle of the table.
...
- **One child:** rotate through Detective, Organizer, and Reporter, while keeping one primary objective for the session.
- **Two children:** Child A leads attribute selection and sorting; Child B leads counting and reporting. They exchange material handling during the second rule without changing the assigned primary objectives.
...
1. One child at a time may return items to the tray while the adult maintains supervision; the others do not handle the collection.
2. The adult checks the table, chairs, and floor and collects every item.
3. The adult places the beans in the rigid container labeled for activity-only use or discards them. Do not return them to the pantry or cook them.
