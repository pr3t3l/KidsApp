> **Histórico — documento en español.** Archivado el 18 de agosto de 2026. La especificación vigente está en [English canonical document](../../../../docs/06-data/conceptual-model.md); no agregar requisitos, decisiones ni cambios nuevos a este registro.
