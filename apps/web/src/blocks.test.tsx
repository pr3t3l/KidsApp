...
describe("block registry", () => {
  ...
  it("renders a versioned V2 block", () => { const block: ContentBlock = { id: "two", kind: "instruction", version: 1, required: true, data: { title: "Observe" } }; expect(renderBlock(block)).not.toBeNull(); });
