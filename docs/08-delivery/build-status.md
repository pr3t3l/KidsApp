...
- Data: 65 public `kids_*` RLS tables across 18 forward-only Kids migrations, plus 11 no-op history markers for the shared Declassified migration ledger, private `kids_*` helpers and server-only secret access.
