...
| Real architecture/data | React, FastAPI, 20 Kids Supabase migrations, RLS, Vault boundary, provider/cost governance | Namespaced academic-pilot database and deterministic bilingual seed deployed; dedicated commercial project pending |
