# Kids Learning System — English documentation

> **Canonical English documentation.** This directory is the normative source from 18 August 2026 under `DEC-052`. Spanish documents are retained in [`historical/es/docs/`](../historical/es/docs/); all new requirements, decisions, and changes belong here.

Use this directory to collaborate in English. The index below mirrors the Spanish source structure.
...
- [compliance baseline](00-foundation/compliance-baseline.md)
- [glossary](00-foundation/glossary.md)
- [open questions](00-foundation/open-questions.md)
- [product principles](00-foundation/product-principles.md)
- [product vision](00-foundation/product-vision.md)
- [scope and releases](00-foundation/scope-and-releases.md)
...
- [ACT-0001 — Paper Bridges](02-content/sample-activities/ACT-0001-puente-de-papel.md)
- [ACT-0002 — Seed Sorting](02-content/sample-activities/ACT-0002-clasificacion-semillas.md)
- [ACT-0003 — Conductivity Tester](02-content/sample-activities/ACT-0003-probador-conductividad.md)
- [visual content pipeline](02-content/visual-content-pipeline.md)

### 03-product

- [community spec](03-product/community-spec.md)
- [editorial platform](03-product/editorial-platform.md)
- [journeys](03-product/journeys.md)
- [module map](03-product/module-map.md)
- [personas](03-product/personas.md)
- [requirements](03-product/requirements.md)
- [subscription spec](03-product/subscription-spec.md)
- [user stories](03-product/user-stories.md)

### 04-ux

- [activity facilitation model](04-ux/activity-facilitation-model.md)
- [activity session](04-ux/flows/activity-session.md)
- [onboarding](04-ux/flows/onboarding.md)
- [session close](04-ux/flows/session-close.md)
- [weekly plan](04-ux/flows/weekly-plan.md)
- [information architecture](04-ux/information-architecture.md)
- [interaction principles](04-ux/interaction-principles.md)
- [screen inventory](04-ux/screen-inventory.md)
...
- [ai provider abstraction](07-engineering/ai-provider-abstraction.md)
...
- [sofia five day dry run v0.1](08-delivery/sofia-five-day-dry-run-v0.1.md)
- [sofia shopping list v0.1](08-delivery/sofia-shopping-list-v0.1.md)
- [traceability](08-delivery/traceability.md)
- [vertical slices](08-delivery/vertical-slices.md)
